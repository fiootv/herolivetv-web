...
export function ServicesHeroSection() {
  return (
    <section className="relative min-h-[400px] md:min-h-[500px] flex items-center justify-center overflow-hidden bg-black py-8 md:py-12">
      <div className="container mx-auto px-4 max-w-7xl relative z-20">
        <div className="bg-gray-900 rounded-3xl md:rounded-[3rem] overflow-hidden relative">
          ...
          {/* Content */}
          <div className="relative z-20 text-center p-8 md:p-12 lg:p-16">
            <motion.div
