      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <motion.div
            ...
            className="relative order-2 lg:order-1 min-h-[400px] md:min-h-[600px] lg:min-h-[700px]"
          >
          ...
          >
            <div className="w-full">
              ...
              <div className="mb-8 md:mb-10">
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-semibold text-gray-900 mb-6">
                  Most Commonly{" "}
                ...
                {faqs.map((faq, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="border border-gray-200 hover:border-primary transition-colors duration-200 rounded-xl md:rounded-2xl overflow-hidden"
                    >
                      {/* Question */}
                      <button
                        onClick={() => toggleFAQ(index)}
                        className="w-full px-5 md:px-6 py-4 md:py-5 flex items-center justify-between text-left bg-white hover:bg-gray-50 transition-colors duration-200"
                      >
