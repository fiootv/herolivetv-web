...
export const metadata: Metadata = {
  title: "IPTV Services – HeroLiveTV | Premium Streaming & Live TV Channels",
  description: "Discover HeroLiveTV's premium IPTV services. Access thousands of live TV channels, movies, series, and on-demand content. Multi-device support, HD quality streaming, and 24/7 customer support.",
  keywords: ["IPTV services", "live TV streaming", "IPTV provider", "streaming service", "TV channels", "on-demand content", "HeroLiveTV services"],
  openGraph: {
    title: "IPTV Services – HeroLiveTV | Premium Streaming & Live TV Channels",
    description: "Discover HeroLiveTV's premium IPTV services. Access thousands of live TV channels, movies, series, and on-demand content.",
