const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://www.herolivetv.com";
const BRAND = "HeroLiveTV";
const PRIMARY = "#FF6B35";
const SUPPORT_EMAIL = "support@herolivetv.com";
const SUPPORT_PHONE = "+1-716-800-3757";
        ...
        <tr>
          <td style="padding:24px 24px 16px;border-bottom:3px solid ${PRIMARY};">
            <a href="${SITE_URL}" style="text-decoration:none;">
              <img src="${SITE_URL}/logo.png" alt="${BRAND}" width="140" height="40" style="display:block;height:40px;width:auto;" />
            </a>
          </td>
        </tr>
